...
impl IntrospectToken {
    pub fn new(
        ...
        Self { exp, active, auth_time, kind }
    }

    pub fn exp(&self) -> Option<u32> { self.exp }
    pub fn active(&self) -> Option<bool> { self.active }
    pub fn auth_time(&self) -> Option<u32> { self.auth_time }
...
impl ClientToken {
    ...
    pub fn expires_in(&self) -> u32 { self.expires_in }
    pub fn refresh_expires_in(&self) -> u32 { self.refresh_expires_in }
    pub fn refresh_token(&self) -> &str { &self.refresh_token }
    pub fn token_type(&self) -> &str { &self.token_type }
    pub fn not_before_policy(&self) -> u32 { self.not_before_policy }
    pub fn session_state(&self) -> &str { &self.session_state }
...
impl LoginRequest {
    ...
    pub fn redirect_url(&self) -> &Url { &self.redirect_url }
}
...
impl LoginResponse {
    ...
    pub fn login_url(&self) -> &Url { &self.login_url }
}
