...
/*
GetEvaluation Get evaluation data
...
*/
func (a *EvaluationAPIService) GetEvaluation(ctx context.Context) ApiGetEvaluationRequest {
	return ApiGetEvaluationRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *EvaluationAPIService) GetEvaluationExecute(r ApiGetEvaluationRequest) (*Evaluation, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EvaluationAPIService.GetEvaluation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/evaluation"
