...
func (r ApiGetAllSensorDataByIdRequest) Execute() (*SensorDataList, *http.Response, error) {
	return r.ApiService.GetAllSensorDataByIdExecute(r)
}
...
func (a *SensorAPIService) GetAllSensorDataByIdExecute(r ApiGetAllSensorDataByIdRequest) (*SensorDataList, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SensorAPIService.GetAllSensorDataById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/sensor/data/{sensor_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"sensor_id"+"}", url.PathEscape(parameterValueToString(r.sensorId, "sensorId")), -1)
