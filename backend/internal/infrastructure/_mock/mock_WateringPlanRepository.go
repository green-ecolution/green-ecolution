...
func (_m *MockWateringPlanRepository) Create(ctx context.Context, fn func(*entities.WateringPlan, entities.WateringPlanRepository) (bool, error)) (*entities.WateringPlan, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, func(*entities.WateringPlan, entities.WateringPlanRepository) (bool, error)) (*entities.WateringPlan, error)); ok {
		return rf(ctx, fn)
	}
	if rf, ok := ret.Get(0).(func(context.Context, func(*entities.WateringPlan, entities.WateringPlanRepository) (bool, error)) *entities.WateringPlan); ok {
		r0 = rf(ctx, fn)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, func(*entities.WateringPlan, entities.WateringPlanRepository) (bool, error)) error); ok {
		r1 = rf(ctx, fn)
	} else {
		r1 = ret.Error(1)
	}
...
//   - ctx context.Context
//   - fn func(*entities.WateringPlan , entities.WateringPlanRepository)(bool , error)
...
func (_c *MockWateringPlanRepository_Create_Call) Run(run func(ctx context.Context, fn func(*entities.WateringPlan, entities.WateringPlanRepository) (bool, error))) *MockWateringPlanRepository_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(func(*entities.WateringPlan, entities.WateringPlanRepository) (bool, error)))
	})
	return _c
}
...
func (_c *MockWateringPlanRepository_Create_Call) RunAndReturn(run func(context.Context, func(*entities.WateringPlan, entities.WateringPlanRepository) (bool, error)) (*entities.WateringPlan, error)) *MockWateringPlanRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockWateringPlanRepository) Update(ctx context.Context, id int32, fn func(*entities.WateringPlan, entities.WateringPlanRepository) (bool, error)) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, int32, func(*entities.WateringPlan, entities.WateringPlanRepository) (bool, error)) error); ok {
		r0 = rf(ctx, id, fn)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockWateringPlanRepository_Update_Call) Run(run func(ctx context.Context, id int32, fn func(*entities.WateringPlan, entities.WateringPlanRepository) (bool, error))) *MockWateringPlanRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int32), args[2].(func(*entities.WateringPlan, entities.WateringPlanRepository) (bool, error)))
	})
	return _c
}
...
func (_c *MockWateringPlanRepository_Update_Call) RunAndReturn(run func(context.Context, int32, func(*entities.WateringPlan, entities.WateringPlanRepository) (bool, error)) error) *MockWateringPlanRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
