...
func (_m *MockTreeRepository) Create(ctx context.Context, fn func(*entities.Tree, entities.TreeRepository) (bool, error)) (*entities.Tree, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, func(*entities.Tree, entities.TreeRepository) (bool, error)) (*entities.Tree, error)); ok {
		return rf(ctx, fn)
	}
	if rf, ok := ret.Get(0).(func(context.Context, func(*entities.Tree, entities.TreeRepository) (bool, error)) *entities.Tree); ok {
		r0 = rf(ctx, fn)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, func(*entities.Tree, entities.TreeRepository) (bool, error)) error); ok {
		r1 = rf(ctx, fn)
	} else {
		r1 = ret.Error(1)
	}
...
//   - ctx context.Context
//   - fn func(*entities.Tree , entities.TreeRepository)(bool , error)
...
func (_c *MockTreeRepository_Create_Call) Run(run func(ctx context.Context, fn func(*entities.Tree, entities.TreeRepository) (bool, error))) *MockTreeRepository_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(func(*entities.Tree, entities.TreeRepository) (bool, error)))
	})
	return _c
}
...
func (_c *MockTreeRepository_Create_Call) RunAndReturn(run func(context.Context, func(*entities.Tree, entities.TreeRepository) (bool, error)) (*entities.Tree, error)) *MockTreeRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockTreeRepository) Update(ctx context.Context, id int32, updateFn func(*entities.Tree, entities.TreeRepository) (bool, error)) (*entities.Tree, error) {
	...
	var r0 *entities.Tree
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int32, func(*entities.Tree, entities.TreeRepository) (bool, error)) (*entities.Tree, error)); ok {
		return rf(ctx, id, updateFn)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int32, func(*entities.Tree, entities.TreeRepository) (bool, error)) *entities.Tree); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, int32, func(*entities.Tree, entities.TreeRepository) (bool, error)) error); ok {
...
//   - ctx context.Context
//   - id int32
//   - updateFn func(*entities.Tree , entities.TreeRepository)(bool , error)
...
func (_c *MockTreeRepository_Update_Call) Run(run func(ctx context.Context, id int32, updateFn func(*entities.Tree, entities.TreeRepository) (bool, error))) *MockTreeRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int32), args[2].(func(*entities.Tree, entities.TreeRepository) (bool, error)))
	})
	return _c
}
...
func (_c *MockTreeRepository_Update_Call) RunAndReturn(run func(context.Context, int32, func(*entities.Tree, entities.TreeRepository) (bool, error)) (*entities.Tree, error)) *MockTreeRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
