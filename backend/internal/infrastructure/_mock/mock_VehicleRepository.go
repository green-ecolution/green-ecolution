...
func (_m *MockVehicleRepository) Create(ctx context.Context, fn func(*entities.Vehicle, entities.VehicleRepository) (bool, error)) (*entities.Vehicle, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, func(*entities.Vehicle, entities.VehicleRepository) (bool, error)) (*entities.Vehicle, error)); ok {
		return rf(ctx, fn)
	}
	if rf, ok := ret.Get(0).(func(context.Context, func(*entities.Vehicle, entities.VehicleRepository) (bool, error)) *entities.Vehicle); ok {
		r0 = rf(ctx, fn)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, func(*entities.Vehicle, entities.VehicleRepository) (bool, error)) error); ok {
		r1 = rf(ctx, fn)
	} else {
		r1 = ret.Error(1)
	}
...
//   - ctx context.Context
//   - fn func(*entities.Vehicle , entities.VehicleRepository)(bool , error)
...
func (_c *MockVehicleRepository_Create_Call) Run(run func(ctx context.Context, fn func(*entities.Vehicle, entities.VehicleRepository) (bool, error))) *MockVehicleRepository_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(func(*entities.Vehicle, entities.VehicleRepository) (bool, error)))
	})
	return _c
}
...
func (_c *MockVehicleRepository_Create_Call) RunAndReturn(run func(context.Context, func(*entities.Vehicle, entities.VehicleRepository) (bool, error)) (*entities.Vehicle, error)) *MockVehicleRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockVehicleRepository) Update(ctx context.Context, id int32, fn func(*entities.Vehicle, entities.VehicleRepository) (bool, error)) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, int32, func(*entities.Vehicle, entities.VehicleRepository) (bool, error)) error); ok {
		r0 = rf(ctx, id, fn)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockVehicleRepository_Update_Call) Run(run func(ctx context.Context, id int32, fn func(*entities.Vehicle, entities.VehicleRepository) (bool, error))) *MockVehicleRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int32), args[2].(func(*entities.Vehicle, entities.VehicleRepository) (bool, error)))
	})
	return _c
}
...
func (_c *MockVehicleRepository_Update_Call) RunAndReturn(run func(context.Context, int32, func(*entities.Vehicle, entities.VehicleRepository) (bool, error)) error) *MockVehicleRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
