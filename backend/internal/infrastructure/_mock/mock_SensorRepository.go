...
func (_m *MockSensorRepository) Create(ctx context.Context, createFn func(*entities.Sensor, entities.SensorRepository) (bool, error)) (*entities.Sensor, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, func(*entities.Sensor, entities.SensorRepository) (bool, error)) (*entities.Sensor, error)); ok {
		return rf(ctx, createFn)
	}
	if rf, ok := ret.Get(0).(func(context.Context, func(*entities.Sensor, entities.SensorRepository) (bool, error)) *entities.Sensor); ok {
		r0 = rf(ctx, createFn)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, func(*entities.Sensor, entities.SensorRepository) (bool, error)) error); ok {
		r1 = rf(ctx, createFn)
	} else {
		r1 = ret.Error(1)
	}
...
//   - ctx context.Context
//   - createFn func(*entities.Sensor , entities.SensorRepository)(bool , error)
...
func (_c *MockSensorRepository_Create_Call) Run(run func(ctx context.Context, createFn func(*entities.Sensor, entities.SensorRepository) (bool, error))) *MockSensorRepository_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(func(*entities.Sensor, entities.SensorRepository) (bool, error)))
	})
	return _c
}
...
func (_c *MockSensorRepository_Create_Call) RunAndReturn(run func(context.Context, func(*entities.Sensor, entities.SensorRepository) (bool, error)) (*entities.Sensor, error)) *MockSensorRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}

// Delete provides a mock function with given fields: ctx, id
func (_m *MockSensorRepository) Delete(ctx context.Context, id entities.SensorID) error {
...
func (_c *MockSensorRepository_Delete_Call) Run(run func(ctx context.Context, id entities.SensorID)) *MockSensorRepository_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockSensorRepository_Delete_Call) RunAndReturn(run func(context.Context, entities.SensorID) error) *MockSensorRepository_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockSensorRepository) GetAllDataByID(ctx context.Context, id entities.SensorID) ([]*entities.SensorData, error) {
	ret := _m.Called(ctx, id)
...
func (_c *MockSensorRepository_GetAllDataByID_Call) Run(run func(ctx context.Context, id entities.SensorID)) *MockSensorRepository_GetAllDataByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(entities.SensorID))
	})
	return _c
...
func (_c *MockSensorRepository_GetAllDataByID_Call) RunAndReturn(run func(context.Context, entities.SensorID) ([]*entities.SensorData, error)) *MockSensorRepository_GetAllDataByID_Call {
	_c.Call.Return(run)
	return _c
}

// GetByID provides a mock function with given fields: ctx, id
func (_m *MockSensorRepository) GetByID(ctx context.Context, id entities.SensorID) (*entities.Sensor, error) {
	ret := _m.Called(ctx, id)
...
func (_c *MockSensorRepository_GetByID_Call) Run(run func(ctx context.Context, id entities.SensorID)) *MockSensorRepository_GetByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(entities.SensorID))
	})
	return _c
...
func (_c *MockSensorRepository_GetByID_Call) RunAndReturn(run func(context.Context, entities.SensorID) (*entities.Sensor, error)) *MockSensorRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockSensorRepository) GetLatestSensorDataBySensorID(ctx context.Context, id entities.SensorID) (*entities.SensorData, error) {
	ret := _m.Called(ctx, id)
...
func (_c *MockSensorRepository_GetLatestSensorDataBySensorID_Call) Run(run func(ctx context.Context, id entities.SensorID)) *MockSensorRepository_GetLatestSensorDataBySensorID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(entities.SensorID))
	})
	return _c
...
func (_c *MockSensorRepository_GetLatestSensorDataBySensorID_Call) RunAndReturn(run func(context.Context, entities.SensorID) (*entities.SensorData, error)) *MockSensorRepository_GetLatestSensorDataBySensorID_Call {
	_c.Call.Return(run)
	return _c
}

// InsertSensorData provides a mock function with given fields: ctx, data, id
func (_m *MockSensorRepository) InsertSensorData(ctx context.Context, data *entities.SensorData, id entities.SensorID) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *entities.SensorData, entities.SensorID) error); ok {
		r0 = rf(ctx, data, id)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockSensorRepository_InsertSensorData_Call) Run(run func(ctx context.Context, data *entities.SensorData, id entities.SensorID)) *MockSensorRepository_InsertSensorData_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*entities.SensorData), args[2].(entities.SensorID))
	})
	return _c
}
...
func (_c *MockSensorRepository_InsertSensorData_Call) RunAndReturn(run func(context.Context, *entities.SensorData, entities.SensorID) error) *MockSensorRepository_InsertSensorData_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function with given fields: ctx, id, updateFn
func (_m *MockSensorRepository) Update(ctx context.Context, id entities.SensorID, updateFn func(*entities.Sensor, entities.SensorRepository) (bool, error)) (*entities.Sensor, error) {
	...
	var r0 *entities.Sensor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, entities.SensorID, func(*entities.Sensor, entities.SensorRepository) (bool, error)) (*entities.Sensor, error)); ok {
		return rf(ctx, id, updateFn)
	}
	if rf, ok := ret.Get(0).(func(context.Context, entities.SensorID, func(*entities.Sensor, entities.SensorRepository) (bool, error)) *entities.Sensor); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, entities.SensorID, func(*entities.Sensor, entities.SensorRepository) (bool, error)) error); ok {
...
//   - ctx context.Context
//   - id entities.SensorID
//   - updateFn func(*entities.Sensor , entities.SensorRepository)(bool , error)
...
func (_c *MockSensorRepository_Update_Call) Run(run func(ctx context.Context, id entities.SensorID, updateFn func(*entities.Sensor, entities.SensorRepository) (bool, error))) *MockSensorRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(entities.SensorID), args[2].(func(*entities.Sensor, entities.SensorRepository) (bool, error)))
	})
	return _c
}
...
func (_c *MockSensorRepository_Update_Call) RunAndReturn(run func(context.Context, entities.SensorID, func(*entities.Sensor, entities.SensorRepository) (bool, error)) (*entities.Sensor, error)) *MockSensorRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
