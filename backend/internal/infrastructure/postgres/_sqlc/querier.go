...
type Querier interface {
	...
	GetAllVehiclesCount(ctx context.Context, arg *GetAllVehiclesCountParams) (int64, error)
	...
	GetLatestSensorDataBySensorIDs(ctx context.Context, sensorIds []string) ([]*SensorDatum, error)
