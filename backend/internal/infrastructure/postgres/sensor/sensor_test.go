...
func TestSensorRepository_Delete(t *testing.T) {
	t.Run("should delete sensor", func(t *testing.T) {
		...
		// when
		err := r.Delete(context.Background(), sensorDomain.MustNewSensorID("sensor-1"))
	...
	t.Run("should return error when sensor not found", func(t *testing.T) {
		...
		// when
		err := r.Delete(context.Background(), sensorDomain.MustNewSensorID("notFoundID"))
	...
	t.Run("should return error when context is canceled", func(t *testing.T) {
		...
		// when
		err := r.Delete(ctx, sensorDomain.MustNewSensorID("sensor-1"))
