...
func (r *RegionRepository) GetAll(ctx context.Context) ([]*shared.Region, int64, error) {
...
func (r *RegionRepository) GetByID(ctx context.Context, id int32) (*shared.Region, error) {
	log := logger.GetLogger(ctx)
...
func (r *RegionRepository) GetByPoint(ctx context.Context, coord shared.Coordinate) (*shared.Region, error) {
	log := logger.GetLogger(ctx)
