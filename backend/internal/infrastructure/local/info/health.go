...
func (h *healthChecker) checkAll(ctx context.Context) []info.ServiceStatus {
	now := time.Now()
	services := []info.ServiceStatus{
...
func (h *healthChecker) checkDatabase(ctx context.Context, now time.Time) info.ServiceStatus {
...
func (h *healthChecker) checkAuth(ctx context.Context, now time.Time) info.ServiceStatus {
	status := info.ServiceStatus{
		Name:        "auth",
...
func (h *healthChecker) checkMQTT(now time.Time) info.ServiceStatus {
...
func (h *healthChecker) checkS3(ctx context.Context, now time.Time) info.ServiceStatus {
	status := info.ServiceStatus{
		Name:        "s3",
...
func (h *healthChecker) checkRouting(ctx context.Context, now time.Time) info.ServiceStatus {
	status := info.ServiceStatus{
		Name:        "routing",
...
func (h *healthChecker) checkVroom(ctx context.Context, now time.Time) info.ServiceStatus {
	status := info.ServiceStatus{
		Name:        "vroom",
