...
func getPluginFiles(svc ports.PluginService) fiber.Handler {
...
func RegisterPlugin(svc ports.PluginService) fiber.Handler {
	return func(c *fiber.Ctx) error {
...
// @Security		Keycloak
func UnregisterPlugin(svc ports.PluginService) fiber.Handler {
	return func(c *fiber.Ctx) error {
		ctx := c.Context()
...
// @Param			plugin_slug	path	string	true	"Unique slug identifier of the plugin"
// @Security		Keycloak
func PluginHeartbeat(svc ports.PluginService) fiber.Handler {
	return func(c *fiber.Ctx) error {
		ctx := c.Context()
		slug := strings.Clone(c.Params("plugin"))
...
// @Security		Keycloak
func GetPluginsList(svc ports.PluginService) fiber.Handler {
	return func(c *fiber.Ctx) error {
		ctx := c.Context()
		p, h := svc.GetAll(ctx)
		log.Println(h)
...
// @Param			plugin_slug	path	string	true	"Unique slug identifier of the plugin"
// @Security		Keycloak
func GetPluginInfo(svc ports.PluginService) fiber.Handler {
	return func(c *fiber.Ctx) error {
		ctx := c.Context()
		pluginParam := strings.Clone(c.Params("plugin"))
		plugin, err := svc.Get(ctx, pluginParam)
...
// @Param			plugin_slug	path	string	true	"Unique slug identifier of the plugin"
func RefreshToken(svc ports.PluginService) fiber.Handler {
	return func(c *fiber.Ctx) error {
