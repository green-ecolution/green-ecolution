...
// @Security		Keycloak
func GetWateringPlanByID(svc ports.WateringPlanService) fiber.Handler {
	return func(c *fiber.Ctx) error {
		ctx := c.Context()
...
// @Security		Keycloak
func CreateWateringPlan(svc ports.WateringPlanService) fiber.Handler {
	return func(c *fiber.Ctx) error {
		ctx := c.Context()
...
// @Security		Keycloak
func UpdateWateringPlan(svc ports.WateringPlanService) fiber.Handler {
	return func(c *fiber.Ctx) error {
		ctx := c.Context()
		id, err := strconv.Atoi(c.Params("id"))
		if err != nil {
...
// @Param			id	path	int	true	"Watering Plan ID"
// @Security		Keycloak
func DeleteWateringPlan(svc ports.WateringPlanService) fiber.Handler {
	return func(c *fiber.Ctx) error {
		ctx := c.Context()
		id, err := strconv.Atoi(c.Params("id"))
		if err != nil {
...
// @Security		Keycloak
func CreatePreviewRoute(svc ports.WateringPlanService) fiber.Handler {
	return func(c *fiber.Ctx) error {
		ctx := c.Context()
...
// @Security		Keycloak
func GetGpxFile(svc ports.WateringPlanService) fiber.Handler {
	return func(c *fiber.Ctx) error {
		ctx := c.Context()
