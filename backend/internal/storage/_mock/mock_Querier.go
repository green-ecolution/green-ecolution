...
func (_m *MockQuerier) GetDistinctPlantingYears(ctx context.Context) ([]int32, error) {
	ret := _m.Called(ctx)
...
// MockQuerier_GetDistinctPlantingYears_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetDistinctPlantingYears'
type MockQuerier_GetDistinctPlantingYears_Call struct {
	*mock.Call
}

// GetDistinctPlantingYears is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockQuerier_Expecter) GetDistinctPlantingYears(ctx interface{}) *MockQuerier_GetDistinctPlantingYears_Call {
	return &MockQuerier_GetDistinctPlantingYears_Call{Call: _e.mock.On("GetDistinctPlantingYears", ctx)}
}

func (_c *MockQuerier_GetDistinctPlantingYears_Call) Run(run func(ctx context.Context)) *MockQuerier_GetDistinctPlantingYears_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockQuerier_GetDistinctPlantingYears_Call) Return(_a0 []int32, _a1 error) *MockQuerier_GetDistinctPlantingYears_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQuerier_GetDistinctPlantingYears_Call) RunAndReturn(run func(context.Context) ([]int32, error)) *MockQuerier_GetDistinctPlantingYears_Call {
	_c.Call.Return(run)
	return _c
}
