...
func (_m *MockQuerier) GetUsersByWateringPlanID(ctx context.Context, wateringPlanID int32) ([]pgtype.UUID, error) {
	ret := _m.Called(ctx, wateringPlanID)
	...
	var r0 []pgtype.UUID
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int32) ([]pgtype.UUID, error)); ok {
		return rf(ctx, wateringPlanID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int32) []pgtype.UUID); ok {
		r0 = rf(ctx, wateringPlanID)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockQuerier_GetUsersByWateringPlanID_Call) Return(_a0 []pgtype.UUID, _a1 error) *MockQuerier_GetUsersByWateringPlanID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQuerier_GetUsersByWateringPlanID_Call) RunAndReturn(run func(context.Context, int32) ([]pgtype.UUID, error)) *MockQuerier_GetUsersByWateringPlanID_Call {
	_c.Call.Return(run)
	return _c
}
